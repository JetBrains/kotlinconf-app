                ...
                NavHost(
                    ...
                    composable<StartScreen> {
                        Column {
                            ...
                            StyledText("About Conference", Modifier.clickable { navController.navigate(AboutConferenceScreen) })
                            StyledText("Code of Conduct", Modifier.clickable { navController.navigate(CodeOfConductScreen) })
                            StyledText("Settings", Modifier.clickable { navController.navigate(SettingsScreen) })
                            StyledText("Terms of use", Modifier.clickable { navController.navigate(TermsOfUseScreen) })
