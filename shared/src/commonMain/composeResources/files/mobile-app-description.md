The KotlinConf application is developed by the JetBrains team with Kotlin Multiplatform shared logic. Compose Multiplatform is used for both apps on Android and iOS. 
