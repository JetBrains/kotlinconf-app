...
fun PrivacyPolicyScreen(onClose: () -> Unit) {
    Column(
        ...
        Column(Modifier.background(color = MaterialTheme.colors.grey5Black)) {
            Text(
                text = "KotlinConf App Privacy Policy".uppercase(),
        ...
        TextContent(
            buildAnnotatedString {
                ...
                append(" which third party hosts and helps us provide you with this App. \n" +
        ...
        TextContent(
            buildAnnotatedString {
                ...
                append(" You may also contact JetBrains to get up-to-date information about your Personal Data processing and any Personal Data recipients.\n" +
