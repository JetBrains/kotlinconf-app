...
private fun AppRoute.toBrowserHistoryFragment() = when (val key = this) {
    ...
    is GoldenKodeeCategoryScreen -> buildBrowserHistoryFragment(
        "golden_kodee_category",
        mapOf("categoryId" to key.categoryId.id)
    )

    is GoldenKodeeNomineeScreen -> buildBrowserHistoryFragment(
        "golden_kodee_nominee",
        ...
        ChronologicalBrowserNavigation(
            ...
            restoreKey = { fragment ->
                ...
                when (name) {
                    ...
                    "license" -> SingleLicenseScreen(
                        params["licenseName"]!!,
                        params["licenseText"]!!
                    )

                    "golden_kodee" -> GoldenKodeeScreen
                    "golden_kodee_category" -> params["categoryId"]?.let {
                        GoldenKodeeCategoryScreen(AwardCategoryId(it))
                    }
                    ...
                    "golden_kodee_nominee" -> {
                        ...
                        if (categoryId != null && nomineeId != null) {
                            GoldenKodeeNomineeScreen(AwardCategoryId(categoryId), NomineeId(nomineeId))
                        } else null
                    }
