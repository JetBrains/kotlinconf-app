        ...
        AwardCategory(
            ...
            nominees = listOf(
                Nominee(
                    ...
                    name = "Aaron Todd",
                    photoUrl =
                        "https://sessionize.com/image/2ef9-400o400o1-XGxKBoqZvxxQxosrZHQHTT.png",
                ...
                Nominee(
                    ...
                    description =
                        "A Kotlin compiler plugin that provides detailed assertion messages by transforming assert calls at compile time.\n\n[Kotlin Programming Language](https://kotlinlang.org) | [KotlinConf on Bluesky](https://bsky.app/profile/kotlinconf.com)",
                    winner = false,
                ),
                Nominee(
