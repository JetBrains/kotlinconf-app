...
private val ADJECTIVES = listOf(
    "Amber", "Brave", "Bright", "Calm", "Clever", "Cosmic", "Curious", "Daring",
    "Eager", "Electric", "Fearless", "Gentle", "Golden", "Happy", "Honest", "Jolly",
    "Keen", "Kind", "Lively", "Lucky", "Mellow", "Merry", "Mighty", "Noble",
    "Plucky", "Proud", "Quiet", "Rapid", "Rusty", "Sharp", "Shy", "Silent",
    "Silver", "Sleepy", "Smooth", "Snappy", "Sneaky", "Spry", "Sunny", "Swift",
    "Tidy", "Vivid", "Witty", "Zany", "Zesty", "Bold", "Cozy", "Frosty",
)

private val ANIMALS = listOf(
    "Aardvark", "Badger", "Beaver", "Bison", "Cheetah", "Cobra", "Crane", "Dolphin",
    "Eagle", "Falcon", "Ferret", "Finch", "Fox", "Gecko", "Gibbon", "Hare",
    "Heron", "Ibex", "Jaguar", "Koala", "Lemur", "Lynx", "Magpie", "Marmot",
    "Mole", "Moose", "Newt", "Ocelot", "Otter", "Owl", "Panda", "Panther",
    "Puffin", "Quokka", "Rabbit", "Raccoon", "Raven", "Robin", "Seal", "Shark",
    "Sloth", "Sparrow", "Stoat", "Tapir", "Toucan", "Walrus", "Weasel", "Wombat",
)
